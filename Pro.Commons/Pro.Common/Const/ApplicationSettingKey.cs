namespace Pro.Common.Const
{
    public static class ApplicationSettingKey
    {
        public const string AppsettingsScanGet = "appsettings_scan_get";
        public const string CloundSetting = "CloundSetting";
